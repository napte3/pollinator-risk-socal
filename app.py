...
st.write("Built by Nikhil Apte | University of Maryland | Combining GIS spatial analysis with business analytics to understand pollinator decline risk across Southern California's agriculture economy.")
st.markdown("---")
